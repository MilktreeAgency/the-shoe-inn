    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-xl shadow-sm p-8 md:p-12 space-y-8">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">1. Introduction</h2>
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">2. Information We Collect</h2>
            <div className="space-y-4 text-text leading-relaxed">
              <div>
                <h3 className="font-bold text-evergreen mb-2">Personal Information</h3>
              ...
              <div>
                <h3 className="font-bold text-evergreen mb-2">Automatically Collected Information</h3>
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">3. How We Use Your Information</h2>
            <p className="text-text leading-relaxed mb-3">We use the information we collect to:</p>
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">4. Cookies</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">5. Data Sharing and Disclosure</h2>
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">6. Data Security</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">7. Your Rights</h2>
            <p className="text-text leading-relaxed mb-3">Under UK GDPR, you have the right to:</p>
            <ul className="list-disc list-inside ml-4 space-y-2 text-text">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">8. Data Retention</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">9. Children's Privacy</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">10. Changes to This Policy</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">11. Contact Us</h2>
