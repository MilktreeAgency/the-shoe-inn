      ...
      <section className="bg-forest-800 text-parchment-100 py-24 px-6 relative overflow-hidden" aria-label="Location and nearby attractions" itemProp="geo" itemScope itemType="https://schema.org/GeoCoordinates">
         ...
         <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center relative z-10">
            ...
            <div className="grid grid-cols-2 gap-4">
                <figure>
                  <img src="/location-image.jpg" className="rounded-sm w-full h-64 object-cover translate-y-8" alt="New Forest National Park heathland and ponies near The Shoe Inn, Hampshire" loading="lazy" />
                </figure>
                <figure>
