    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-xl shadow-sm p-8 md:p-12 space-y-8">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">2. Bookings and Reservations</h2>
            <div className="space-y-4 text-text leading-relaxed">
              <div>
                <h3 className="font-bold text-evergreen mb-2">Table Reservations</h3>
              ...
              <div>
                <h3 className="font-bold text-evergreen mb-2">Room Bookings</h3>
                <ul className="list-disc list-inside ml-4 space-y-2">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">3. Cancellation Policy</h2>
            <div className="space-y-4 text-text leading-relaxed">
              <div>
                <h3 className="font-bold text-evergreen mb-2">Room Cancellations</h3>
                <ul className="list-disc list-inside ml-4 space-y-2">
              ...
              <div>
                <h3 className="font-bold text-evergreen mb-2">Table Cancellations</h3>
                <ul className="list-disc list-inside ml-4 space-y-2">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">4. Payment Terms</h2>
            <ul className="list-disc list-inside ml-4 space-y-2 text-text">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">5. Guest Conduct</h2>
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">6. Children and Pets</h2>
            <div className="text-text leading-relaxed space-y-3">
              <p>
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">7. Food and Dietary Requirements</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">8. Liability</h2>
            <div className="text-text leading-relaxed space-y-3">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">9. Intellectual Property</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">10. Force Majeure</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">11. Changes to Terms</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">12. Governing Law</h2>
            <p className="text-text leading-relaxed">
          ...
          <section>
            <h2 className="font-heading font-bold text-2xl text-evergreen mb-4">13. Contact Information</h2>
            <div className="text-text leading-relaxed space-y-2">
