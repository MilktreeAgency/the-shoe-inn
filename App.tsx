...
const PageHeader: React.FC<PageHeaderProps> = ({ title, subtitle, bgImage, altText }) => (
  <header className="relative h-[40vh] min-h-[400px] flex items-center justify-center bg-evergreen overflow-hidden" role="banner">
    ...
    <div className="relative z-10 text-center px-4">
      <h1 className="font-heading font-bold text-5xl md:text-6xl text-floral mb-4 drop-shadow-lg">{title}</h1>
      {subtitle && <p className="text-floral/80 text-lg max-w-xl mx-auto drop-shadow-md">{subtitle}</p>}
    </div>
  </header>
);
...
const FoodPage: React.FC = () => (
    <article className="bg-floral min-h-screen" itemScope itemType="https://schema.org/Restaurant">
            ...
            <div className="max-w-4xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center text-floral">
                    <div className="bg-white/5 rounded-xl p-4">
                        ...
                        <p className="text-sm text-floral/80">3pm to 9.30pm</p>
                    </div>
                    <div className="bg-white/5 rounded-xl p-4">
                        <p className="font-bold text-floral">Friday & Saturday</p>
                        <p className="text-sm text-floral/80">12pm to 10pm</p>
                    </div>
                    <div className="bg-white/5 rounded-xl p-4">
                        <p className="font-bold text-floral">Sunday</p>
                        <p className="text-sm text-floral/80">12pm to 8pm</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <SectionBlock ariaLabel="Food gallery showcasing our menu">
            <div className="mb-20">
                <div className="text-center mb-12">
                     ...
                     <p className="text-text max-w-2xl mx-auto">Authentic Punjabi curries, sizzling mixed grills, and aromatic spices. Honest, flavourful cooking from the heart of Punjab.</p>
                </div>
            ...
            <div className="mb-20" itemScope itemType="https://schema.org/Menu">
                <div className="text-center mb-12">
                    <h2 className="font-heading font-bold text-4xl text-evergreen mb-4">The Shoe Inn Indian Gastro Pub</h2>
                    <p className="text-text max-w-2xl mx-auto">Our full menu of authentic Punjabi North Indian cuisine.</p>
                </div>

                {/* Tandoori Sizzler's */}
                <div className="mb-12" itemProp="hasMenuSection" itemScope itemType="https://schema.org/MenuSection">
                    <h3 className="font-heading font-bold text-2xl text-evergreen mb-6 pb-2 border-b-2 border-terracotta" itemProp="name">Tandoori Sizzler's</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Chicken Tikka</h4>
                                <p className="text-sm text-text" itemProp="description">Marinated chicken in mixture of yogurt, chilli and garlic</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4" itemProp="offers" itemScope itemType="https://schema.org/Offer"><span itemProp="price">£13.95</span></span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Hariyali Chicken</h4>
                                <p className="text-sm text-text" itemProp="description">Marinated chicken in a mixture of mint, coriander and spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£13.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Malai Chicken</h4>
                                <p className="text-sm text-text" itemProp="description">Marinated chicken in a mixture of yogurt, cream and spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£13.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Chicken Wings</h4>
                                <p className="text-sm text-text" itemProp="description">Marinated chicken in a mixture of mint, coriander and spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£13.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Sheesh Kebab</h4>
                                <p className="text-sm text-text" itemProp="description">Mince lamb meat with a mixture of garam masala and methi</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£13.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Lamb Chops</h4>
                                <p className="text-sm text-text" itemProp="description">Marinated lamb in a mixture of yogurt, coriander and spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£14.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Amritsari Fish</h4>
                                <p className="text-sm text-text" itemProp="description">Marinated in a blend of ginger, garlic and spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£14.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">King Prawns</h4>
                                <p className="text-sm text-text" itemProp="description">Marinated prawn in a mixture of herbs and spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£19.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash" itemProp="hasMenuItem" itemScope itemType="https://schema.org/MenuItem">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen" itemProp="name">Paneer Tikka <span className="text-green-600 text-xs font-bold">(V)</span></h4>
                                <p className="text-sm text-text" itemProp="description">Cheese marinated in a mixture of yogurt, chilli, and garlic</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£12.95</span>
                        </div>
                    </div>
                </div>
                ...
                {/* Wraps & Kebabs */}
                <div className="mb-12" itemProp="hasMenuSection" itemScope itemType="https://schema.org/MenuSection">
                    <h3 className="font-heading font-bold text-2xl text-evergreen mb-6 pb-2 border-b-2 border-terracotta" itemProp="name">Wraps & Kebabs</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Tandoori Chicken</h4>
                                <p className="text-sm text-text">Tikka / Hariyali / Malai</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£10.95 / £11.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Sheesh Kebab</h4>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£10.95 / £11.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Mixed Chicken & Sheesh</h4>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£10.95 / £11.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Paneer <span className="text-green-600 text-xs font-bold">(V)</span></h4>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£10.95 / £11.95</span>
                        </div>
                    </div>
                ...
                {/* Shoe Inn Grills */}
                <div className="mb-12" itemProp="hasMenuSection" itemScope itemType="https://schema.org/MenuSection">
                    <h3 className="font-heading font-bold text-2xl text-evergreen mb-6 pb-2 border-b-2 border-terracotta" itemProp="name">Shoe Inn Grills</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Small Mix Grill</h4>
                                <p className="text-sm text-text">Tandoori Chicken (Tikka/Hariyali/Malai), Tandoori Chicken Wings, Sheesh Kebab, Lamb Chops</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£13.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Medium Mix Grill</h4>
                                <p className="text-sm text-text">Tandoori Chicken (Tikka/Hariyali/Malai), Tandoori Chicken Wings, Sheesh Kebab, Lamb Chops</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£24.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Large Mix Grill</h4>
                                <p className="text-sm text-text">Tandoori Chicken (Tikka/Hariyali/Malai), Tandoori Chicken Wings, Sheesh Kebab, Lamb Chops</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£32.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Boneless Mix Grill</h4>
                                <p className="text-sm text-text">Tandoori Chicken Tikka, Tandoori Chicken Hariyali, Tandoori Chicken Malai</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£19.95</span>
                        </div>
                    </div>
                ...
                {/* Home-Style Curries */}
                <div className="mb-12" itemProp="hasMenuSection" itemScope itemType="https://schema.org/MenuSection">
                    <h3 className="font-heading font-bold text-2xl text-evergreen mb-6 pb-2 border-b-2 border-terracotta" itemProp="name">Home-Style Curries</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Butter Chicken</h4>
                                <p className="text-sm text-text">Chargrill chicken in a rich and creamy base sauce</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£12.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Chicken Karahi</h4>
                                <p className="text-sm text-text">Chicken cooked with fresh ginger, garlic and Indian spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£12.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Lamb Karahi</h4>
                                <p className="text-sm text-text">Lamb cooked with fresh ginger, garlic and Indian spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£12.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Butter Paneer <span className="text-green-600 text-xs font-bold">(V)</span></h4>
                                <p className="text-sm text-text">Tandoori paneer in a sweet creamy tomato sauce with Indian spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£10.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Dal Makhani <span className="text-green-600 text-xs font-bold">(V)</span></h4>
                                <p className="text-sm text-text">Black lentils & red kidney beans cooked in a rich tomato-based sauce</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£8.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Saag <span className="text-green-600 text-xs font-bold">(V)</span></h4>
                                <p className="text-sm text-text">Spinach blended and cooked with fresh garlic, onions, spices and herbs</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£8.95</span>
                        </div>
                        <div className="flex justify-between items-start p-4 bg-white rounded-xl border border-ash">
                            <div>
                                <h4 className="font-heading font-bold text-evergreen">Bombay Aloo <span className="text-green-600 text-xs font-bold">(V)</span></h4>
                                <p className="text-sm text-text">Potatoes cooked with fresh ginger, garlic, onions and Indian spices</p>
                            </div>
                            <span className="font-bold text-evergreen whitespace-nowrap ml-4">£7.95</span>
                        </div>
                    </div>
                </div>
                ...
                {/* Breads & Rice */}
                <div className="mb-12" itemProp="hasMenuSection" itemScope itemType="https://schema.org/MenuSection">
                    <h3 className="font-heading font-bold text-2xl text-evergreen mb-6 pb-2 border-b-2 border-terracotta" itemProp="name">Breads & Rice</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Plain Chips</span>
                            <span className="font-bold text-evergreen">£3.50</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Masala Chips</span>
                            <span className="font-bold text-evergreen">£3.95</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Chilli Chips</span>
                            <span className="font-bold text-evergreen">£4.50</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Pilau Rice</span>
                            <span className="font-bold text-evergreen">£2.95</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Plain Naan</span>
                            <span className="font-bold text-evergreen">£2.75</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Garlic Naan</span>
                            <span className="font-bold text-evergreen">£2.95</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Chilli Cheese Naan</span>
                            <span className="font-bold text-evergreen">£3.25</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Keema Naan</span>
                            <span className="font-bold text-evergreen">£3.25</span>
                        </div>
                    </div>
                </div>
                ...
                {/* Sides */}
                <div className="mb-12" itemProp="hasMenuSection" itemScope itemType="https://schema.org/MenuSection">
                    <h3 className="font-heading font-bold text-2xl text-evergreen mb-6 pb-2 border-b-2 border-terracotta" itemProp="name">Sides</h3>
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Poppadom (2pc)</span>
                            <span className="font-bold text-evergreen">£1.80</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Samosa (3pc)</span>
                            <span className="font-bold text-evergreen">£4.50</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Onion Bhaji (3pc)</span>
                            <span className="font-bold text-evergreen">£4.50</span>
                        </div>
                        <div className="flex justify-between items-center p-4 bg-white rounded-xl border border-ash">
                            <span className="font-heading font-bold text-evergreen">Salad</span>
                            <span className="font-bold text-evergreen">£2.95</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
                <a href="https://gamma.app/docs/SHOE-INN-WINE-LIST-2vfa9gk0tvo2588" target="_blank" rel="noopener noreferrer" className="bg-white p-8 border border-ash rounded-xl hover:shadow-lg transition-shadow group cursor-pointer relative overflow-hidden block">
                   ...
                   <span className="text-xs font-bold uppercase tracking-widest text-evergreen flex items-center gap-2 relative z-10">View Wine List <ChevronRight size={14} aria-hidden="true"/></span>
                </a>
                <a href="/nannies-menu.pdf" target="_blank" rel="noopener noreferrer" className="p-8 rounded-xl hover:shadow-lg transition-shadow group cursor-pointer relative overflow-hidden block">
                   ...
                   <div className="relative z-10">
                       ...
                       <h3 className="font-heading font-bold text-2xl text-white mb-2 group-hover:text-accent transition-colors">Nannies Caribbean Kitchen</h3>
                       ...
                       <span className="text-xs font-bold uppercase tracking-widest text-accent flex items-center gap-2">View Menu <ChevronRight size={14} aria-hidden="true"/></span>
                   </div>
                </a>
            </div>
        </SectionBlock>
        ...
        <SectionBlock ariaLabel="Drinks offering">
            <div className="text-center max-w-2xl mx-auto">
                <h2 className="font-heading font-bold text-3xl text-evergreen mb-6">Drinks</h2>
...
const RoomsPage: React.FC = () => (
    <article className="bg-floral min-h-screen" itemScope itemType="https://schema.org/LodgingBusiness">
        ...
        <SectionBlock>
            <div className="max-w-3xl mx-auto text-center mb-16">
                 ...
                 <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                     <a 
                         ...
                         className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#003580] text-white font-heading font-bold uppercase tracking-widest hover:bg-[#00254d] transition-colors rounded-xl shadow-lg"
                     >
                         Book on Booking.com
                     </a>
                     <a 
                         ...
                         target="_blank"
                         rel="noopener noreferrer"
                         className="inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#FF5A5F] text-white font-heading font-bold uppercase tracking-widest hover:bg-[#e04a4f] transition-colors rounded-xl shadow-lg"
                     >
                         View on Airbnb
                     </a>
                 </div>
            ...
            <div className="mb-16">
                <h2 className="font-heading font-bold text-2xl text-evergreen mb-8 text-center">En-Suite Rooms</h2>
                <div className="grid gap-12">
                    {[
                        ...
                        <div key={index} className="bg-white grid grid-cols-1 md:grid-cols-2 rounded-xl overflow-hidden shadow-sm border border-ash">
                            ...
                            <div className="p-8 flex flex-col justify-center">
                                <h3 className="font-heading font-bold text-2xl text-evergreen mb-2">{room.title}</h3>
                                <p className="text-text text-sm mb-6">{room.desc}</p>
                                ...
                                <div className="flex flex-col sm:flex-row gap-2 mb-4">
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex-1 py-3 bg-[#003580] text-white font-heading font-bold uppercase tracking-widest hover:bg-[#00254d] transition-colors rounded-xl flex items-center justify-center gap-2 text-xs"
                                    >
                                        Booking.com
                                    </a>
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex-1 py-3 bg-[#FF5A5F] text-white font-heading font-bold uppercase tracking-widest hover:bg-[#e04a4f] transition-colors rounded-xl flex items-center justify-center gap-2 text-xs"
                                    >
                                        Airbnb
                                    </a>
                                </div>
                                ...
                                <div className="flex flex-wrap gap-4 justify-between items-center mt-auto pt-6 border-t border-gray-100">
                                    <span className="text-evergreen font-bold text-lg">{room.price}</span>
                                </div>
                            </div>
                        </div>
                    ))}
            ...
            <div className="mb-16">
                <h2 className="font-heading font-bold text-2xl text-evergreen mb-8 text-center">Family Studios with Kitchenette</h2>
                <p className="text-text text-center max-w-2xl mx-auto mb-8">Perfect for families and longer stays. Each studio includes a kitchenette for self-catering convenience.</p>
                <div className="grid gap-12">
                    {[
                        {
                            id: 6,
        ...
        <section className="bg-white py-16 px-6 border-t border-ash">
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="font-heading font-bold text-2xl text-evergreen mb-6">Cruise Ship Stays & Nearby Campsites</h2>
                ...
                <div className="flex flex-col items-center gap-2 text-sm text-evergreen">
        ...
        <section className="bg-evergreen py-16 px-6">
            <div className="max-w-4xl mx-auto text-center">
                <h2 className="font-heading font-bold text-3xl text-floral mb-4">
                    Prefer to Book Elsewhere?
                </h2>
                <p className="text-floral/80 mb-8 max-w-2xl mx-auto">
                ...
                <p className="mt-6 text-xs text-floral/50">
...
const LocationPage: React.FC = () => (
    <article className="bg-floral min-h-screen">
        <PageHeader 
        ...
        <section className="py-16 px-6 max-w-6xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-sm border border-ash flex flex-col items-center text-center">
                    <div className="w-12 h-12 bg-pink-100 text-pink-500 rounded-full flex items-center justify-center mb-4"><Baby size={24}/></div>
                    <h3 className="font-heading font-bold text-lg text-evergreen">Paultons Park</h3>
                    <p className="text-sm text-text mt-2">Home of Peppa Pig World</p>
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-ash flex flex-col items-center text-center">
                    ...
                    <h3 className="font-heading font-bold text-lg text-evergreen">New Forest</h3>
                    <p className="text-sm text-text mt-2">National Park Access</p>
                    <div className="mt-4 pt-4 border-t border-gray-100 w-full flex justify-between items-center text-xs font-bold text-forest-600 uppercase">
                ...
                <div className="bg-white p-6 rounded-xl shadow-sm border border-ash flex flex-col items-center text-center">
                    ...
                    <h3 className="font-heading font-bold text-lg text-evergreen">Salisbury</h3>
                    <p className="text-sm text-text mt-2">Historic Cathedral City</p>
                    <div className="mt-4 pt-4 border-t border-gray-100 w-full flex justify-between items-center text-xs font-bold text-forest-600 uppercase">
                 ...
                 <div className="bg-white p-6 rounded-xl shadow-sm border border-ash flex flex-col items-center text-center">
                    ...
                    <h3 className="font-heading font-bold text-lg text-evergreen">Romsey</h3>
                    <p className="text-sm text-text mt-2">Market Town & Abbey</p>
                    <div className="mt-4 pt-4 border-t border-gray-100 w-full flex justify-between items-center text-xs font-bold text-forest-600 uppercase">
        ...
        <SectionBlock>
            <div className="space-y-24">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                    <div>
                         <span className="text-xs font-bold uppercase tracking-widest text-evergreen/60 mb-2 block">Family Travel</span>
                         <h2 className="font-heading font-bold text-3xl md:text-4xl text-evergreen mb-6">The Smart Way to Visit Paultons Park</h2>
                         ...
                         <div className="bg-white p-6 border-l-4 border-terracotta shadow-sm">
                             <h4 className="font-heading font-bold text-lg text-evergreen mb-3 flex items-center gap-2"><Info size={18}/> Insider Tip</h4>
                    ...
                    <figure className="h-80 lg:h-full bg-gray-200 rounded-xl overflow-hidden relative group">
                ...
                {/* Guide 2: Walking */}
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                     <figure className="order-2 lg:order-1 h-80 lg:h-full bg-gray-200 rounded-xl overflow-hidden relative group">
                    ...
                    <div className="order-1 lg:order-2">
                         <span className="text-xs font-bold uppercase tracking-widest text-evergreen/60 mb-2 block">Nature & Dogs</span>
                         <h2 className="font-heading font-bold text-3xl md:text-4xl text-evergreen mb-6">Walks from the Doorstep</h2>
                         <p className="text-text text-lg mb-6 leading-relaxed">
                         ...
                         <ul className="space-y-4 mb-8">
                             <li className="flex items-start gap-3">
                                 <div className="mt-1 bg-forest-100 p-1 rounded-full"><Dog size={14} className="text-evergreen"/></div>
                                 <div>
                                     <strong className="block text-evergreen">Dog Friendly Pub</strong>
                                     <span className="text-sm text-text">We welcome muddy paws in the bar area and have designated dog-friendly rooms.</span>
                                 </div>
                             </li>
                             <li className="flex items-start gap-3">
                                 <div className="mt-1 bg-forest-100 p-1 rounded-full"><Compass size={14} className="text-evergreen"/></div>
                                 <div>
                                     <strong className="block text-evergreen">Plaitford Common Loop (45 mins)</strong>
                                     <span className="text-sm text-text">Ask at the bar for a printed map of our favourite circular route.</span>
                                 </div>
                             </li>
                         </ul>
                    </div>
            ...
            <div className="max-w-5xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                        <h3 className="font-heading font-bold text-xl text-accent mb-4">Nearby Campsites</h3>
                        <p className="text-floral/80 mb-4">We welcome visitors from local campsites for meals and drinks.</p>
                        <ul className="space-y-2 text-floral">
                            <li className="flex items-center gap-2"><Trees size={16} className="text-accent" /> Green Hill Farm campsite</li>
                            <li className="flex items-center gap-2"><Trees size={16} className="text-accent" /> Pyemead Farm campsite</li>
                        </ul>
                    </div>
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                        <h3 className="font-heading font-bold text-xl text-accent mb-4">Cruise Ship Stay & Parking</h3>
                        <p className="text-floral/80 mb-4">Convenient for the Southampton cruise terminal. Park with us and stay overnight before or after your voyage.</p>
                        <p className="text-floral font-medium">Parking for approximately 50 cars</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section className="bg-white py-20 px-6 border-t border-ash">
            <div className="max-w-3xl mx-auto">
                <div className="text-center mb-12">
                    <span className="inline-block p-2 bg-floral rounded-full text-evergreen mb-4"><HelpCircle size={24}/></span>
                    <h2 className="font-heading font-bold text-3xl text-evergreen">Frequently Asked Questions</h2>
                    <p className="text-text mt-2">Everything you need to know before you visit.</p>
                </div>
                ...
                <div className="space-y-4">
                    {[
                        ...
                        <details key={idx} className="group bg-floral rounded-xl border border-ash overflow-hidden">
                            <summary className="flex justify-between items-center font-heading font-bold text-lg text-evergreen p-6 cursor-pointer hover:bg-floral transition-colors list-none">
                                {item.q}
                                <span className="transition-transform group-open:rotate-180"><ChevronRight size={20}/></span>
                            </summary>
                            <div className="px-6 pb-6 text-text leading-relaxed">
                                {item.a}
                            </div>
                        </details>
                    ))}
        ...
        <section className="h-[400px] relative bg-gray-200">
             ...
             <div className="absolute inset-0 bg-evergreen flex items-center justify-center">
                 <div className="text-center p-8 bg-white/10 backdrop-blur-md rounded-xl border border-white/20">
                     ...
                     <p className="text-floral">Salisbury Road, Plaitford, Romsey, SO51 6EE</p>
                     <Button 
                        variant="primary" 
                        className="mt-6"
...
const WhyUsPage: React.FC<{ onNavigate: (page: Page) => void; onOpenTableModal: () => void }> = ({ onNavigate, onOpenTableModal }) => (
    <article className="bg-floral min-h-screen">
        ...
        <section className="py-20 px-6 bg-floral">
            <motion.div 
                initial="hidden"
                whileInView="visible"
                viewport={{ once: true }}
            ...
            >
                <div className="w-px h-16 bg-evergreen/20 mx-auto mb-8"></div>
                ...
                <p className="text-evergreen/60 font-heading font-bold uppercase tracking-widest text-sm mt-8">
        ...
        <section className="bg-evergreen text-floral overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                ...
                <div className="flex flex-col justify-center p-12 lg:p-24 order-1 lg:order-2">
                    ...
                    <p className="text-floral/80 mb-4 leading-relaxed text-lg">
                        Our kitchen is dedicated to Punjabi North Indian food. That is it.
                    </p>
                    <p className="text-floral/80 mb-6 leading-relaxed">
                    ...
                    <p className="text-floral font-medium">
        ...
        <section className="bg-floral overflow-hidden">
            <div className="grid grid-cols-1 lg:grid-cols-2 h-full">
                <div className="flex flex-col justify-center p-12 lg:p-24 order-1">
                    ...
                    <h2 className="font-heading font-bold text-evergreen text-4xl md:text-5xl mb-6">Rooms That Make Staying Easy</h2>
                    <p className="text-text mb-8 leading-relaxed text-lg">
                        We have eight rooms available, designed for comfort and practicality.
                    </p>
                    <ul className="space-y-4 mb-8">
                        <li className="flex items-center gap-3 text-evergreen font-medium">
        ...
        <section className="py-24 px-6 bg-white">
            <div className="max-w-6xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="font-heading font-bold text-3xl md:text-4xl text-evergreen mb-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
                    {[
                        ...
                        <motion.div 
                            ...
                            className="bg-floral p-6 rounded-xl border border-ash text-center hover:shadow-lg transition-all duration-300"
                        >
                            <div className="w-12 h-12 mx-auto mb-4 bg-evergreen/10 rounded-full flex items-center justify-center">
                                <item.Icon size={24} className="text-evergreen" />
                            </div>
                            <p className="font-heading font-bold text-evergreen">{item.label}</p>
                        </motion.div>
                    ))}
                </div>
                <p className="text-center text-text mt-12 text-lg italic">
        ...
        <section className="py-24 px-6 bg-evergreen text-floral">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                        <h3 className="font-heading font-bold text-xl text-accent mb-4">Nearby Campsites</h3>
                        <ul className="space-y-3 text-floral/80">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20">
                        <h3 className="font-heading font-bold text-xl text-accent mb-4">Cruise Ship Parking</h3>
                        <p className="text-floral/80 leading-relaxed">
                ...
                <div className="text-center">
                    <Button 
                        variant="outline" 
                        className="text-floral border-pearl hover:bg-floral hover:text-evergreen" 
        ...
        <section className="py-20 px-6 bg-floral">
            <div className="max-w-4xl mx-auto">
                <div className="bg-white p-8 md:p-12 rounded-xl shadow-lg border border-ash flex flex-col md:flex-row items-center gap-8">
                    <div className="flex-shrink-0 w-16 h-16 bg-evergreen/10 rounded-full flex items-center justify-center">
                        <Beer size={32} className="text-evergreen" />
                    </div>
                    <div>
                        <h3 className="font-heading font-bold text-2xl text-evergreen mb-4">Backing British Producers</h3>
        ...
        <section className="py-24 px-6 bg-evergreen text-floral">
            <div className="max-w-4xl mx-auto text-center">
                ...
                <p className="text-floral text-lg mb-10 max-w-2xl mx-auto">
        ...
        <section className="py-24 px-6 bg-white">
            <div className="max-w-5xl mx-auto">
                <div className="text-center mb-16">
                    <h2 className="font-heading font-bold text-3xl md:text-4xl text-evergreen">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {[
                        ...
                        <motion.div 
                            ...
                            className="flex items-center gap-4 p-6 bg-floral rounded-xl border border-ash"
                        >
                            <div className="flex-shrink-0 w-12 h-12 bg-evergreen/10 text-evergreen rounded-full flex items-center justify-center">
                                {item.icon}
                            </div>
                            <p className="text-evergreen font-medium">{item.text}</p>
                        </motion.div>
                    ))}
                </div>
            </div>
        ...
        {/* Final CTA Section */}
        <section className="py-24 px-6 bg-floral border-t border-ash">
            <div className="max-w-4xl mx-auto bg-evergreen rounded-xl p-8 md:p-16 text-center relative overflow-hidden shadow-2xl">
                ...
                <div className="relative z-10">
                    <h2 className="font-heading font-bold text-3xl md:text-5xl text-floral mb-6">
                        Book, Stay, or Get in Touch
                    </h2>
                    <p className="text-floral text-lg mb-10 max-w-xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Button 
                            variant="outline" 
                            size="lg" 
                            className="border-pearl text-floral hover:bg-floral hover:text-evergreen" 
...
const ContactPage: React.FC = () => (
    <article className="bg-floral min-h-screen">
        ...
        <SectionBlock ariaLabel="Contact form">
             <div className="max-w-2xl mx-auto bg-white p-8 md:p-12 shadow-xl border-t-4 border-terracotta">
                 <form className="space-y-6" aria-label="Contact enquiry form">
                     <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         <div className="space-y-2">
                             <label className="text-xs font-bold uppercase tracking-widest text-evergreen">Name</label>
                             <input type="text" className="w-full p-3 border border-gray-300 bg-floral focus:border-terracotta focus:outline-none transition-colors" placeholder="Your name" />
                         </div>
                         <div className="space-y-2">
                             <label className="text-xs font-bold uppercase tracking-widest text-evergreen">Email</label>
                             <input type="email" className="w-full p-3 border border-gray-300 bg-floral focus:border-terracotta focus:outline-none transition-colors" placeholder="Your email" />
                         </div>
                     </div>
                     <div className="space-y-2">
                         <label className="text-xs font-bold uppercase tracking-widest text-evergreen">Enquiry Type</label>
                         <select className="w-full p-3 border border-gray-300 bg-floral focus:border-terracotta focus:outline-none transition-colors">
                     ...
                     <div className="space-y-2">
                         <label className="text-xs font-bold uppercase tracking-widest text-evergreen">Message</label>
                         <textarea rows={4} className="w-full p-3 border border-gray-300 bg-floral focus:border-terracotta focus:outline-none transition-colors" placeholder="How can we help?"></textarea>
                     </div>
                     <button type="button" className="w-full py-4 bg-evergreen text-white font-heading font-bold uppercase tracking-widest hover:bg-accent transition-colors duration-300">
                         Send Message
                     </button>
                 </form>
             </div>
    ...
    <article className="bg-floral min-h-screen">
        ...
        <SectionBlock className="max-w-4xl">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                 ...
                 {/* Room Booking Column */}
                 <div className="bg-white p-8 md:p-10 rounded-xl shadow-md border border-ash flex flex-col items-center text-center">
                    <Bed size={40} className="text-evergreen mb-6" />
                    <h2 className="font-heading font-bold text-2xl text-evergreen mb-3">Stay With Us</h2>
                 ...
                 <div className="bg-evergreen p-8 md:p-10 rounded-xl shadow-md border border-forest-800 flex flex-col items-center text-center text-floral">
                    <Utensils size={40} className="text-accent mb-6" />
                    <h2 className="font-heading font-bold text-2xl mb-3">Dine With Us</h2>
                    <p className="text-floral/80 mb-8 text-sm leading-relaxed">
                        Join us for authentic Punjabi cuisine. Reservations recommended, especially for weekends.
                    </p>
                    <div className="w-full mt-auto">
                        <button 
                            onClick={onOpenTableModal}
                            className="w-full py-4 bg-floral text-evergreen font-heading font-bold uppercase tracking-widest hover:bg-white transition-colors rounded-md"
                        >
                            Book a Table
                        </button>
                        <p className="mt-6 text-xs text-floral/50">
    ...
    <article className="bg-floral min-h-screen">
        ...
        <SectionBlock ariaLabel="Paultons Park accommodation guide">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                 <div>
                     <h2 className="font-heading font-bold text-3xl text-evergreen mb-6">Family Fun, Minutes Away</h2>
                     <p className="text-text mb-6 leading-relaxed">
                     ...
                     <ul className="space-y-3 mb-8">
                         <li className="flex items-center gap-2 text-evergreen font-medium"><Baby size={18} className="text-evergreen/60" aria-hidden="true"/> Dedicated Kids Menu</li>
                         <li className="flex items-center gap-2 text-evergreen font-medium"><Trees size={18} className="text-evergreen/60" aria-hidden="true"/> Large Beer Garden</li>
                         <li className="flex items-center gap-2 text-evergreen font-medium"><Car size={18} className="text-evergreen/60" aria-hidden="true"/> Large Car Park</li>
                     </ul>
                     <Button onClick={() => onNavigate('contact')}>Book a Family Table</Button>
                 </div>
                 <figure className="rounded-xl overflow-hidden shadow-lg rotate-2 hover:rotate-0 transition-transform duration-500">
...
const NewForestPage: React.FC<{ onNavigate: (page: Page) => void }> = ({ onNavigate }) => (
    <article className="bg-floral min-h-screen">
        ...
        <SectionBlock ariaLabel="New Forest walking routes guide">
             <div className="max-w-3xl mx-auto text-center mb-16">
                 <h2 className="font-heading font-bold text-3xl text-evergreen mb-6">A Walkers' Paradise</h2>
                 <p className="text-text leading-relaxed">
             ...
             <div className="grid grid-cols-1 md:grid-cols-3 gap-8" role="list" aria-label="Walking routes near The Shoe Inn">
                 <div className="bg-white p-6 border border-ash shadow-sm" role="listitem">
                     <h3 className="font-heading font-bold text-xl text-evergreen mb-2">Plaitford Common</h3>
                     <p className="text-sm text-text mb-4">A gentle circular walk starting right from the pub. Great for dog walking.</p>
                     <span className="text-xs font-bold text-evergreen uppercase">Distance: 2.5 Miles</span>
                 </div>
                 <div className="bg-white p-6 border border-ash shadow-sm" role="listitem">
                     <h3 className="font-heading font-bold text-xl text-evergreen mb-2">Canada Common</h3>
                     <p className="text-sm text-text mb-4">Open heathland with spectacular views and free-roaming ponies.</p>
                     <span className="text-xs font-bold text-evergreen uppercase">Distance: 4 Miles</span>
                 </div>
                 <div className="bg-white p-6 border border-ash shadow-sm" role="listitem">
                     <h3 className="font-heading font-bold text-xl text-evergreen mb-2">Bramshaw Wood</h3>
                     <p className="text-sm text-text mb-4">Ancient woodland famous for its autumn colours and pigs during pannage.</p>
                     <span className="text-xs font-bold text-evergreen uppercase">Distance: 6 Miles</span>
                 </div>
             </div>
        </SectionBlock>
    </article>
...
const SalisburyPage: React.FC<{ onNavigate: (page: Page) => void }> = ({ onNavigate }) => (
    <article className="bg-floral min-h-screen">
        ...
        <SectionBlock ariaLabel="Salisbury visitor information">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                 <figure className="order-2 md:order-1 h-80 md:h-auto bg-gray-200 rounded-xl overflow-hidden">
                 ...
                 <div className="order-1 md:order-2 flex flex-col justify-center">
                     <h2 className="font-heading font-bold text-3xl text-evergreen mb-6">Historic Salisbury</h2>
                     <p className="text-text mb-6 leading-relaxed">
...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <a 
        href="#main-content" 
        className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[100] focus:bg-evergreen focus:text-white focus:px-4 focus:py-2 focus:rounded"
      >
        Skip to main content
      </a>
      
      <div className="flex flex-col min-h-screen font-sans text-charcoal bg-floral selection:bg-accent selection:text-white pb-20 lg:pb-0">
        <Navbar 
        ...
        <nav 
          className="fixed bottom-0 left-0 right-0 bg-white/95 backdrop-blur-sm border-t border-ash p-3 z-30 grid grid-cols-2 gap-3 lg:hidden shadow-[0_-5px_15px_rgba(0,0,0,0.05)]"
          aria-label="Quick booking actions"
        >
          <Button 
              variant="primary" 
              className="w-full text-xs h-12 shadow-none bg-evergreen text-white hover:bg-evergreen/90"
          ...
          <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full text-xs h-12 shadow-none bg-accent text-white font-heading font-bold uppercase tracking-widest hover:bg-accent/90 transition-colors rounded-xl flex items-center justify-center"
